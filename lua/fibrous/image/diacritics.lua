-- Row/column diacritics for kitty Unicode image placeholders, vendored from
-- kitty's gen/rowcolumn-diacritics.txt (297 combining characters; index 1 in
-- this array encodes row/column 0). Generated data, do not hand-edit.
